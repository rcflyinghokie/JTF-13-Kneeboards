...
add_text("Page 3",mediumText,12,  -- add a level 1 subheader  (function located in 'drawingDefinitions.lua')
				functions.Center(1.25*GetAspect(), "Page 3", modifier*largeText),
